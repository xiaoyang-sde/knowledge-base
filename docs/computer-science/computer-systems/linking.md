...
- Relocatable object file contains binary code and data in a form that could be combined with other relocatable object files at compile time. (Generated by assembler and compiler)
