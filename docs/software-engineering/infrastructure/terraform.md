...
Local names are module-specific, and are assigned when requiring a provider. Outside of the `required_providers` block, Terraform configurations always refer to providers by their local names. (e.g. `mycloud`)
